...
[x] - You may use the API key AIzaSyC9iT33vKT-pb7Lrok97X5aNPhGlY6iDBo.  This is not an unlimited key and may only be used for this assignment.
[x] - The developer may use whatever language they choose
[x] - The developer may make use of third party libraries if they choose, however they should NOT use Google's Places API client
[x] - The code should be written with a production level of quality, as if it were going to be distributed as-is
